    ...
    variants: {
      variant: {
        ...
        outline:
          ...
          " border [border-color:var(--button-outline)] bg-background/50 backdrop-blur-sm shadow-sm hover:shadow-md active:shadow-sm ",
        ...
        ghost: "border border-transparent hover:bg-accent/50 rounded-full",
      },
